      ...
      <main className="mx-auto max-w-6xl px-6">
        <section className="pt-20 pb-16">
          ...
          <h1 className="mt-4 max-w-3xl text-5xl font-semibold leading-[1.05] tracking-tight sm:text-6xl">
            Drop the offer.<br/>Drop the screenshot.<br/>
            <span className="text-primary">Know if it's a scam.</span>
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            A recruiter DM'd you on LinkedIn. An "offer letter" landed in your inbox.
            Drop any of it — screenshot, PDF, forwarded email, or a link — and ANVIX reads it,
            cross-checks it live, matches it to <span className="text-foreground">known scam playbooks</span>,
            and tells you exactly what they'll ask for next.
          </p>
        ...
        <section className="grid gap-4 pb-16 sm:grid-cols-4">
          {[
            { icon: FileSearch, title: "Drop any evidence", body: "Screenshots, PDFs, forwarded .eml, links, text — Gemini vision reads all of it." },
            { icon: Search, title: "Live verification", body: "DNS · MX · SPF · DMARC · SSL · WHOIS — checked in real time against the recruiter's domain." },
            { icon: BrainCircuit, title: "Trained ML model", body: "Kaggle EMSCAD-trained model + rule-weighted baseline. Real ROC-AUC, real recall, published." },
            { icon: Sparkles, title: "Scam playbook match", body: "Matches your case to 12 known scam scripts and predicts what the scammer will ask for next." },
