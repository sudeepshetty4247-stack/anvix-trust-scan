...
export const PLAYBOOKS: Playbook[] = [
  {
    ...
    summary:
      "Fake employer 'ships' a laptop and asks you to pay for it upfront, promising first-paycheck reimbursement.",
    signals: [
      "mentions company laptop",
      "asks for advance payment",
      "'reimbursed in first salary'",
      "courier delay",
    ],
    steps: [
    ...
    advice:
      "No legitimate employer ever charges you for equipment. Stop, do not pay, and report to the platform where you found the recruiter.",
  },
  {
    id: "training_fee",
    name: "Training / Certification Fee",
    summary:
      "Job is contingent on paying for a 'mandatory training', 'certification', or 'portal activation'.",
    signals: [
      "training fee",
      "certification fee",
      "activation fee",
      "portal login purchase",
      "refundable deposit",
    ],
    steps: [
    ...
    advice:
      "Real employers pay for your training. Any recruitment step that requires you to pay is a scam.",
  },
  {
    id: "check_overpayment",
    name: "Check Overpayment / Fake Deposit",
    summary:
      "Employer sends a check or wire transfer for more than needed and asks you to refund the difference.",
    signals: [
      "overpayment",
      "refund the difference",
      "buy equipment on our behalf",
      "gift cards",
      "money order",
    ],
    steps: [
    ...
    advice:
      "Never accept a payment and forward part of it elsewhere. Wait 10 business days for full clearance before touching any funds an 'employer' sends.",
  },
  {
    id: "crypto_payroll",
    name: "Crypto / USDT Payroll",
    summary:
      "Legit-sounding role that insists on payroll in cryptocurrency, or asks you to hold funds in a crypto wallet.",
    signals: [
      "payroll in USDT",
      "bitcoin wallet",
      "we pay in crypto",
      "hold funds for us",
      "crypto onboarding bonus",
    ],
    steps: [
    ...
    advice:
      "No legitimate employer requires crypto onboarding. Any request for a wallet, private key, or seed phrase is a scam.",
  },
  {
    id: "task_pyramid",
    name: "Task-Scam Pyramid",
    summary:
      "'Simple daily tasks' (like/rate/review) with commissions that require you to top up your account to unlock higher tiers.",
    signals: [
      "daily tasks",
      "commission per task",
      "recharge to unlock",
    ...
    advice:
      "Any job that requires you to deposit your own money to earn more is a pyramid scam. Withdraw whatever you can immediately and cut contact.",
  },
  {
    id: "visa_processing",
    name: "Visa / Relocation Fee",
    summary:
      "Foreign 'employer' offers a role abroad and asks you to pay visa, relocation, or immigration processing fees.",
    signals: [
      "visa processing fee",
      "relocation deposit",
    ...
    advice:
      "Legitimate international employers use their own immigration lawyers and never route fees through the candidate.",
  },
  {
    id: "fake_hr_portal",
    name: "Fake HR Onboarding Portal",
    summary:
      "Slick-looking onboarding portal that harvests government ID, bank details, and passwords.",
    signals: [
      "onboarding portal",
      "verify Aadhaar",
      "upload PAN",
    ...
    advice:
      "Real employers verify ID after you sign the offer, on official domains, and never ask for OTP or bank login.",
  },
  {
    id: "reshipper_mule",
    name: "Package Reshipper / Money Mule",
    summary:
      "'Logistics coordinator' or 'quality inspector' role where you receive parcels or payments and forward them.",
    signals: [
      "reship packages",
      "quality inspect items",
    ...
    advice:
      "This is a money-mule scheme. Stop receiving and forwarding anything, keep records, and consider filing a police report.",
  },
  {
    id: "whatsapp_only_recruiter",
    name: "WhatsApp / Telegram-Only Recruiter",
    summary:
      "Recruiter refuses any verifiable channel and pushes the entire hiring flow through personal chat apps.",
    ...
    advice:
      "Insist on a company email and a video call on the company's official platform. A recruiter who refuses is not a recruiter.",
  },
  {
    id: "brand_impersonation",
    name: "Brand Impersonation",
    summary:
      "Scammer uses a famous employer's name (Google, Amazon, Microsoft, TCS, Infosys) with an unofficial email domain.",
    signals: [
      "mentions Fortune-500 company",
      "recruiter uses gmail/outlook",
      "lookalike domain",
      "logo copied",
    ],
    steps: [
    ...
    advice:
      "Look up the company's careers page directly and confirm the recruiter through a verified employee on LinkedIn before proceeding.",
  },
  {
    id: "data_entry_advance",
    name: "Data Entry Advance Fee",
    summary:
      "'Home-based data entry' role that requires paying for software, keyboard, or a starter kit.",
  ...
  },
  {
    ...
    summary:
      "During or after 'interview', the 'manager' urgently asks you to buy gift cards for a client / off-site meeting.",
    ...
    advice:
      "No manager will ever ask you to buy gift cards. Verify the request on a different channel with the real person.",
  },
];
